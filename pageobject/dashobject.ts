...
export class DashboardPage {
  ...
  readonly navigateDashboardPage: string;
  ...
  constructor(page: Page) {
    ...
    this.dashboardPage = page.locator('#nav-item-dashboard');
    this.navigateDashboardPage = 'https://bps-dev-web-cjhdeqb4chg7fvdp.australiaeast-01.azurewebsites.net/profiling/dashboard';
  }
